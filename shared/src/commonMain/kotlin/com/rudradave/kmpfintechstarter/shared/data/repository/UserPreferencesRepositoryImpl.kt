...
internal class UserPreferencesRepositoryImpl(
    ...
    private val onboardingCompletedFlow = dataStore.data.map { it[ONBOARDING_COMPLETED] ?: false }
    private val biometricEnabledFlow = dataStore.data.map { it[BIOMETRIC_ENABLED] ?: false }
    private val darkModeFlow = dataStore.data.map { it[DARK_MODE] }
    ...
    override fun isBiometricEnabled(): Flow<Boolean> = biometricEnabledFlow
